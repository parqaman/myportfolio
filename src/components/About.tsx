...
export default function About() {
  return (
    <section
      id="about"
      className="min-h-screen px-6 py-24 md:py-0 bg-background-secondary flex items-center justify-center"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-body text-calm leading-loose">
              I'm a Cloud and AI consultant bridging infrastructure and software
              development to deliver scalable solutions. My work ranges from
              designing and maintaining secure GCP environments hosting AI/ML
              workloads to full-stack development for MLOps governance, and
